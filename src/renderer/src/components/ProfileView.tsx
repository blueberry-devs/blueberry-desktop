        ...
        <>
          ...
          <div className="profile-view__content">
            ...
            <div className="profile-view__cards">
              <div className="profile-view__card" style={{ animationDelay: '0.02s' }}>
              ...
              <div className="profile-view__card" style={{ animationDelay: '0.06s' }}>
                <div className="profile-view__card-icon">
                  <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                ...
                <span className="profile-view__card-value">{profile.followingCount.toLocaleString()}</span>
              </div>
              <div className="profile-view__card" style={{ animationDelay: '0.10s' }}>
                ...
                <span className="profile-view__card-value">{profile.publicPlaylistsCount.toLocaleString()}</span>
              </div>
              <div className="profile-view__card" style={{ animationDelay: '0.14s' }}>
                ...
                <span className="profile-view__card-value">{profile.libraryTracksCount.toLocaleString()}</span>
              </div>
              {tier && (
